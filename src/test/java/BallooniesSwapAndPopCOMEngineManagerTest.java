...
public class BallooniesSwapAndPopCOMEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(BallooniesSwapAndPopCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/BallooniesSwapAndPopIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/BallooniesSwapAndPopIW/InitOutcome.xml").getDocumentElement();
